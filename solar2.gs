...
*************** BEGIN to read Model data
    ...
    'open /Users/tang/climate/Modeling/333/Had.G71E0001/output.RCP85.2088-2100/pprcmdata/yearly/Had_rcp85.SRF.timmean.2090-2099.nc.ctl'
    'set dfile 1'
    'q file'
    'define rsds1=(rsds)'
...
* 'color -var difmid -kind blue->white->red'
    'd cc'
    'draw title electricity potential trend to late 21 century (%)'
    'cbarn 0.6 0 5.5 0.2'
* ----------------------------- to draw mean bias
    'd aave(cc,global)'
    ...
    say 'mean='meanbias
    'drawstr -p 12 -k 5 -z 0.25 -t "mean: 0.21" -xo -0.3 -yo -3.2'
